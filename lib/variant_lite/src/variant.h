...
#if defined(variant_CPP11_OR_GREATER) || variant_COMPILER_MSVC_VERSION >= 10
# define variant_HAVE_AUTO  1
# define variant_HAVE_NULLPTR  1
# define variant_HAVE_STATIC_ASSERT  1
#endif

#if defined(variant_CPP11_OR_GREATER) || variant_COMPILER_MSVC_VERSION >= 12
# define variant_HAVE_DEFAULT_FUNCTION_TEMPLATE_ARG  1
# define variant_HAVE_INITIALIZER_LIST  1
#endif

#if defined(variant_CPP11_OR_GREATER) || variant_COMPILER_MSVC_VERSION >= 14
...
#if defined(variant_CPP11_OR_GREATER) || variant_COMPILER_MSVC_VERSION >= 14 || (variant_COMPILER_MSVC_VERSION >= 9 && _HAS_CPP0X)
...
#ifdef variant_HAVE_INITIALIZER_LIST
# include <initializer_list>
#endif

#ifdef variant_HAVE_TYPE_TRAITS
# include <type_traits>
#elif defined(variant_HAVE_TR1_TYPE_TRAITS)
...
struct vTX : T
{
                        inline vTX<T> operator+ (           ) const { return vTX<T>();  }
                        inline vTX<T> operator- (           ) const { return vTX<T>();  }

                        inline vTX<T> operator! (           ) const { return vTX<T>();  }
                        inline vTX<T> operator~ (           ) const { return vTX<T>();  }

                        inline vTX<T>*operator& (           ) const { return variant_nullptr; }

    template< class U > inline vTX<T> operator* ( U const & ) const { return vTX<T>();  }
    template< class U > inline vTX<T> operator/ ( U const & ) const { return vTX<T>();  }
...
struct S0{}; typedef vTX<S0> T0;
struct S1{}; typedef vTX<S1> T1;
struct S2{}; typedef vTX<S2> T2;
struct S3{}; typedef vTX<S3> T3;
struct S4{}; typedef vTX<S4> T4;
struct S5{}; typedef vTX<S5> T5;
struct S6{}; typedef vTX<S6> T6;
struct S7{}; typedef vTX<S7> T7;
struct S8{}; typedef vTX<S8> T8;
struct S9{}; typedef vTX<S9> T9;
struct S10{}; typedef vTX<S10> T10;
struct S11{}; typedef vTX<S11> T11;
struct S12{}; typedef vTX<S12> T12;
struct S13{}; typedef vTX<S13> T13;
struct S14{}; typedef vTX<S14> T14;
struct S15{}; typedef vTX<S15> T15;
...
#ifdef variant_CONFIG_MAX_ALIGN_HACK
...
template< typename R, typename VT >
struct VisitorApplicatorImpl<R, vTX<VT> >
{
    template< typename Visitor, typename T >
